const backLabels={en:'Back to Lumina Core',tr:'Lumina Core\'a Dön',ru:'Назад к Lumina Core',es:'Volver a Lumina Core'};
const privacyLabels={en:'Privacy Policy',tr:'Gizlilik Politikası',ru:'Конфиденциальность',es:'Privacidad'};
...
function setLang(l){
  ...
  document.querySelector('.lbl-privacy').textContent=privacyLabels[l]||privacyLabels.en;
